...
namespace gte
{
    ...
    private:
        // Binary space partitioning tree support for polygon Boolean operations.
        class BSPTree2
        {
        public:
            // Construction and destruction.
            ...
            // Disallow copying and assignment.  Use GetCopy() instead to obtain
            // a deep copy of the BSP tree.
                    ...
                    if (t1 > (Real)0 && t0 < tmax)
                    {
                        ...
                        else
                        {
                            for (iter = intervals.begin(); iter != intervals.end(); ++iter)
                            {
                                ...
                                LogAssert(t0 >= iter->t1, "Invalid ordering.");
    ...
    private:
        void SplitEdge(int v0, int v1, int vmid)
        {
            ...
            LogAssert(iter != mEMap.end(), "Edge does not exist in the map.");
        ...
        {
            LogAssert(mTree != 0, "Tree must exist.");
