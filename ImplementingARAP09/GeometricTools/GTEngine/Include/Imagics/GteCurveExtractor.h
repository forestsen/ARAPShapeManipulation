...
// File Version: 3.23.0 (2019/03/08)
...
namespace gte
{
    ...
    public:
        ...
        struct Vertex
        {
            ...
            bool operator<(Vertex const& other) const
            {
                ...
                return yn0tyd1 < yn1tyd0;  // yn0/yd0 < yn1/yd1
            }
    ...
    protected:
            ...
            mInputPixels(inputPixels)
        {
            ...
            if (mXBound <= 1 || mYBound <= 1 || mInputPixels == nullptr)
            {
                LogError("Invalid input to CurveExtractor constructor.");
                return;
            }
