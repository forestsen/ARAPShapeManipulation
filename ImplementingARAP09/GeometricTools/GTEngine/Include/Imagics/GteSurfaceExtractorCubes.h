    ...
    protected:
        ...
        void GetXMinEdges(int x, int y, int z, int type, VETable& table)
        {
            ...
            case 15:
            {
                ...
                int64_t f00 = this->mVoxels[i];  // F(x,y,z)
                i += this->mXBound;
                int64_t f10 = this->mVoxels[i];  // F(x,y+1,z)
                i += this->mXYBound;
                int64_t f11 = this->mVoxels[i];  // F(x,y+1,z+1)
                i -= this->mXBound;
                int64_t f01 = this->mVoxels[i];  // F(x,y,z+1)
        ...
        void GetYMinEdges(int x, int y, int z, int type, VETable& table)
        {
            ...
            case 15:
            {
                ...
                int64_t f00 = this->mVoxels[i];  // F(x,y,z)
                ++i;
                int64_t f10 = this->mVoxels[i];  // F(x+1,y,z)
                i += this->mXYBound;
                int64_t f11 = this->mVoxels[i];  // F(x+1,y,z+1)
                --i;
                int64_t f01 = this->mVoxels[i];  // F(x,y,z+1)
                int64_t det = f00 * f11 - f01 * f10;
        ...
        void GetZMinEdges(int x, int y, int z, int type, VETable& table)
        {
            ...
            case 15:
            {
                ...
                int64_t f10 = this->mVoxels[i];  // F(x+1,y,z)
                i += this->mXBound;
                int64_t f11 = this->mVoxels[i];  // F(x+1,y+1,z)
                --i;
                int64_t f01 = this->mVoxels[i];  // F(x,y+1,z)
                int64_t det = f00 * f11 - f01 * f10;
