...
namespace gte
{
    ...
    public:
            ...
            mZMerge(mSize, mSize)
        {
            ...
            {
                LogError("Invalid input to AdaptiveSkeletonClimbing3 constructor.");
                return;
            }
        ...
        void PrintBoxes(std::string const& filename)
        {
    ...
    private:
        ...
        void GetXMinEdgesS(OctBox const& box, unsigned int type, VETable& table)
        {
            ...
            {
            case  0: return;
            case  3: table.InsertEdge(EI_XMIN_YMIN, EI_XMIN_YMAX); break;
            case  5: table.InsertEdge(EI_XMIN_YMIN, EI_XMIN_ZMIN); break;
            case  6: table.InsertEdge(EI_XMIN_YMAX, EI_XMIN_ZMIN); break;
            case  9: table.InsertEdge(EI_XMIN_YMIN, EI_XMIN_ZMAX); break;
            case 10: table.InsertEdge(EI_XMIN_YMAX, EI_XMIN_ZMAX); break;
            case 12: table.InsertEdge(EI_XMIN_ZMIN, EI_XMIN_ZMAX); break;
            case 15:
            {
                // Four vertices, one per edge, need to disambiguate.
                int i = box.x0 + mSize * (box.y0 + mSize * box.z0);
                int64_t f00 = static_cast<int64_t>(mInputVoxels[i]);  // F(x,y,z)
                i += mSize;
                int64_t f10 = static_cast<int64_t>(mInputVoxels[i]);  // F(x,y+1,z)
                i += mSizeSqr;
                int64_t f11 = static_cast<int64_t>(mInputVoxels[i]);  // F(x,y+1,z+1)
                i -= mSize;
                int64_t f01 = static_cast<int64_t>(mInputVoxels[i]);  // F(x,y,z+1)
        ...
        void GetXMaxEdgesS(OctBox const& box, unsigned int type, VETable& table)
        {
            ...
            {
            case  0: return;
            case  3: table.InsertEdge(EI_XMAX_YMIN, EI_XMAX_YMAX); break;
            case  5: table.InsertEdge(EI_XMAX_YMIN, EI_XMAX_ZMIN); break;
            case  6: table.InsertEdge(EI_XMAX_YMAX, EI_XMAX_ZMIN); break;
            case  9: table.InsertEdge(EI_XMAX_YMIN, EI_XMAX_ZMAX); break;
            case 10: table.InsertEdge(EI_XMAX_YMAX, EI_XMAX_ZMAX); break;
            case 12: table.InsertEdge(EI_XMAX_ZMIN, EI_XMAX_ZMAX); break;
            case 15:
            {
                // Four vertices, one per edge, need to disambiguate.
        ...
        void GetYMinEdgesS(OctBox const& box, unsigned int type, VETable& table)
        {
            ...
            {
            case  0: return;
            case  3: table.InsertEdge(EI_XMIN_YMIN, EI_XMAX_YMIN); break;
            case  5: table.InsertEdge(EI_XMIN_YMIN, EI_YMIN_ZMIN); break;
            case  6: table.InsertEdge(EI_XMAX_YMIN, EI_YMIN_ZMIN); break;
            case  9: table.InsertEdge(EI_XMIN_YMIN, EI_YMIN_ZMAX); break;
            case 10: table.InsertEdge(EI_XMAX_YMIN, EI_YMIN_ZMAX); break;
            case 12: table.InsertEdge(EI_YMIN_ZMIN, EI_YMIN_ZMAX); break;
            case 15:
            {
                // Four vertices, one per edge, need to disambiguate.
                int i = box.x0 + mSize * (box.y0 + mSize * box.z0);
                int64_t f00 = static_cast<int64_t>(mInputVoxels[i]);  // F(x,y,z)
                ++i;
                int64_t f10 = static_cast<int64_t>(mInputVoxels[i]);  // F(x+1,y,z)
                i += mSizeSqr;
                int64_t f11 = static_cast<int64_t>(mInputVoxels[i]);  // F(x+1,y,z+1)
                --i;
                int64_t f01 = static_cast<int64_t>(mInputVoxels[i]);  // F(x,y,z+1)
                int64_t det = f00 * f11 - f01 * f10;
        ...
        void GetYMaxEdgesS(OctBox const& box, unsigned int type, VETable& table)
        {
            ...
            {
            case  0: return;
            case  3: table.InsertEdge(EI_XMIN_YMAX, EI_XMAX_YMAX); break;
            case  5: table.InsertEdge(EI_XMIN_YMAX, EI_YMAX_ZMIN); break;
            case  6: table.InsertEdge(EI_XMAX_YMAX, EI_YMAX_ZMIN); break;
            case  9: table.InsertEdge(EI_XMIN_YMAX, EI_YMAX_ZMAX); break;
            case 10: table.InsertEdge(EI_XMAX_YMAX, EI_YMAX_ZMAX); break;
            case 12: table.InsertEdge(EI_YMAX_ZMIN, EI_YMAX_ZMAX); break;
            case 15:
            {
                // Four vertices, one per edge, need to disambiguate.
        ...
        void GetZMinEdgesS(OctBox const& box, unsigned int type, VETable& table)
        {
            ...
            {
            case  0: return;
            case  3: table.InsertEdge(EI_XMIN_ZMIN, EI_XMAX_ZMIN); break;
            case  5: table.InsertEdge(EI_XMIN_ZMIN, EI_YMIN_ZMIN); break;
            case  6: table.InsertEdge(EI_XMAX_ZMIN, EI_YMIN_ZMIN); break;
            case  9: table.InsertEdge(EI_XMIN_ZMIN, EI_YMAX_ZMIN); break;
            case 10: table.InsertEdge(EI_XMAX_ZMIN, EI_YMAX_ZMIN); break;
            case 12: table.InsertEdge(EI_YMIN_ZMIN, EI_YMAX_ZMIN); break;
            case 15:
            {
                // Four vertices, one per edge, need to disambiguate.
                int i = box.x0 + mSize * (box.y0 + mSize * box.z0);
                ...
                int64_t f10 = static_cast<int64_t>(mInputVoxels[i]);  // F(x+1,y,z)
                i += mSize;
                int64_t f11 = static_cast<int64_t>(mInputVoxels[i]);  // F(x+1,y+1,z)
                --i;
                int64_t f01 = static_cast<int64_t>(mInputVoxels[i]);  // F(x,y+1,z)
                int64_t det = f00 * f11 - f01 * f10;
        ...
        void GetZMaxEdgesS(const OctBox& box, unsigned int type, VETable& table)
        {
            ...
            {
            case  0: return;
            case  3: table.InsertEdge(EI_XMIN_ZMAX, EI_XMAX_ZMAX); break;
            case  5: table.InsertEdge(EI_XMIN_ZMAX, EI_YMIN_ZMAX); break;
            case  6: table.InsertEdge(EI_XMAX_ZMAX, EI_YMIN_ZMAX); break;
            case  9: table.InsertEdge(EI_XMIN_ZMAX, EI_YMAX_ZMAX); break;
            case 10: table.InsertEdge(EI_XMAX_ZMAX, EI_YMAX_ZMAX); break;
            case 12: table.InsertEdge(EI_YMIN_ZMAX, EI_YMAX_ZMAX); break;
            case 15:
            {
                // Four vertices, one per edge, need to disambiguate.
        ...
        void GetZMinEdgesM(OctBox const& box, unsigned int type, VETable& table)
        {
            ...
            default: LogError("The level value cannot be an exact integer.");
            }
