...
namespace gte
{
    ...
    public:
        ...
        void TransformBy(Matrix4x4<Real> const& hmatrix, BoundingSphere& sphere) const
        {
            ...
            Real r0 = std::abs(hmatrix(0, 0)) + std::abs(hmatrix(0, 1)) + std::abs(hmatrix(0, 2));
            Real r1 = std::abs(hmatrix(1, 0)) + std::abs(hmatrix(1, 1)) + std::abs(hmatrix(1, 2));
            Real r2 = std::abs(hmatrix(2, 0)) + std::abs(hmatrix(2, 1)) + std::abs(hmatrix(2, 2));
            ...
            Real r0 = std::abs(hmatrix(0, 0)) + std::abs(hmatrix(1, 0)) + std::abs(hmatrix(2, 0));
            Real r1 = std::abs(hmatrix(0, 1)) + std::abs(hmatrix(1, 1)) + std::abs(hmatrix(2, 1));
            Real r2 = std::abs(hmatrix(0, 2)) + std::abs(hmatrix(1, 2)) + std::abs(hmatrix(2, 2));
            Real norm = std::max(std::max(r0, r1), r2);
#endif
