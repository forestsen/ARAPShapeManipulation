...
namespace gte
{
    ...
    // pointer.  Class Node derives from Spatial has an array of child
    // pointers.  The leaf nodes of the hierarchy are either graphical or
    // audial.  Class Visual derives from Spatial and represents graphical
    // data.  Class Audial derives from Spatial and represents sound data.
